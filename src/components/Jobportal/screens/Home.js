...
//                 jobsApplied: [...prevState.jobApplied, {jobID:true}]
//             }))
//         })
//         .catch(error => {
//             console.log(error);
...
//                                  {item.jobDesignation}
//                                </Typography>
//                                <Typography color="textSecondary" variant="h6" gutterBottm>
//                                   {item.companyName}
//                                </Typography>
//                                <div style={{ display: "flex", flexDirection: "row"}}>
//                                   <Typography variant="subtitle1" color="textSecondary" gutterBottom>
//                                     <DateRangeIcon style={{ position: 'relative', top: "4px"}} fontSize="small" />
//                                     {item.lastdate}
//                                   </Typography>
//                                   <Typography style={{paddingLeft: 20}} variant="subtitle1" color="textSecondary" gutterBottom>
//                                     <LocationCityicon style={{ position: 'relative', top: '4px'}} fontSize="small" />
//                                     {item.location}
//                                   </Typography>
//                                </div>
//                                <Button disabled={this.state.jobsApplied.hasOwnProperty(item.jobID)} onClick={() => this.buttonClicked(item.jobID)} 
//                                  style={{ marginTop: "10px"}} variant="contained" color="secondary"
//                                >
